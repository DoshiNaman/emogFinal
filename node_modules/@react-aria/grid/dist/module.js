...
$e506453b0899c672fdbf2f4855f3721d$exports = JSON.parse("{\"deselectedItem\":\"Položka {item} není vybrána.\",\"select\":\"Vybrat\",\"selectedAll\":\"Vybrány všechny položky.\",\"selectedCount\":\"{count, plural, =0 {Nevybrány žádné položky} one {Vybrána # položka} other {Vybráno # položek}}.\",\"selectedItem\":\"Vybrána položka {item}.\"}");
...
$f209544680a65b4d4c1f36b455e32f8e$exports = JSON.parse("{\"deselectedItem\":\"{item} ikke valgt.\",\"select\":\"Vælg\",\"selectedAll\":\"Alle elementer valgt.\",\"selectedCount\":\"{count, plural, =0 {Ingen elementer valgt} one {# element valgt} other {# elementer valgt}}.\",\"selectedItem\":\"{item} valgt.\"}");
...
$dfc27c2d5479ed590d5c135298a3dd7a$exports = JSON.parse("{\"deselectedItem\":\"{item} nicht ausgewählt.\",\"select\":\"Auswählen\",\"selectedAll\":\"Alle Elemente ausgewählt.\",\"selectedCount\":\"{count, plural, =0 {Keine Elemente ausgewählt} one {# Element ausgewählt} other {# Elemente ausgewählt}}.\",\"selectedItem\":\"{item} ausgewählt.\"}");
...
$d087ea4b714dcffa2dde8822c5ee123$exports = JSON.parse("{\"deselectedItem\":\"{item} no seleccionado.\",\"select\":\"Seleccionar\",\"selectedAll\":\"Todos los elementos seleccionados.\",\"selectedCount\":\"{count, plural, =0 {Ningún elemento seleccionado} one {# elemento seleccionado} other {# elementos seleccionados}}.\",\"selectedItem\":\"{item} seleccionado.\"}");
...
$dfbb5dd2cf76066829f535b9b7512de$exports = JSON.parse("{\"deselectedItem\":\"{item} pole valitud.\",\"select\":\"Vali\",\"selectedAll\":\"Kõik üksused valitud.\",\"selectedCount\":\"{count, plural, =0 {Üksusi pole valitud} one {# üksus valitud} other {# üksust valitud}}.\",\"selectedItem\":\"{item} valitud.\"}");
...
$fe1857136085cd04ddc4b69d893957$exports = JSON.parse("{\"deselectedItem\":\"Kohdetta {item} ei valittu.\",\"select\":\"Valitse\",\"selectedAll\":\"Kaikki kohteet valittu.\",\"selectedCount\":\"{count, plural, =0 {Ei yhtään kohdetta valittu} one {# kohde valittu} other {# kohdetta valittu}}.\",\"selectedItem\":\"{item} valittu.\"}");
...
$dfe8baae84cd225984055f0cfc3d268$exports = JSON.parse("{\"deselectedItem\":\"{item} non sélectionné.\",\"select\":\"Sélectionner\",\"selectedAll\":\"Tous les éléments sélectionnés.\",\"selectedCount\":\"{count, plural, =0 {Aucun élément sélectionné} one {# élément sélectionné} other {# éléments sélectionnés}}.\",\"selectedItem\":\"{item} sélectionné.\"}");
...
$ae5e649f2351c1ee4f214d7d3d2fee34$exports = JSON.parse("{\"deselectedItem\":\"{item} nincs kijelölve.\",\"select\":\"Kijelölés\",\"selectedAll\":\"Az összes elem kijelölve.\",\"selectedCount\":\"{count, plural, =0 {Egy elem sincs kijelölve} one {# elem kijelölve} other {# elem kijelölve}}.\",\"selectedItem\":\"{item} kijelölve.\"}");
...
$d871c3e83f9373444be2a825fd274$exports = JSON.parse("{\"deselectedItem\":\"Nie zaznaczono {item}.\",\"select\":\"Zaznacz\",\"selectedAll\":\"Wszystkie zaznaczone elementy.\",\"selectedCount\":\"{count, plural, =0 {Nie zaznaczono żadnych elementów} one {# zaznaczony element} other {# zaznaczonych elementów}}.\",\"selectedItem\":\"Zaznaczono {item}.\"}");
...
$fce09a65f13a12236975366a41fa3fc$exports = JSON.parse("{\"deselectedItem\":\"{item} não selecionado.\",\"select\":\"Selecionar\",\"selectedAll\":\"Todos os itens selecionados.\",\"selectedCount\":\"{count, plural, =0 {Nenhum item selecionado} one {# item selecionado} other {# itens selecionados}}.\",\"selectedItem\":\"{item} selecionado.\"}");
...
$de306f55572f07861710d9ca39f9c$exports = JSON.parse("{\"deselectedItem\":\"{item} não selecionado.\",\"select\":\"Selecionar\",\"selectedAll\":\"Todos os itens selecionados.\",\"selectedCount\":\"{count, plural, =0 {Nenhum item selecionado} one {# item selecionado} other {# itens selecionados}}.\",\"selectedItem\":\"{item} selecionado.\"}");
...
$e3fc3d4894b1affa2ff3d7c41eee3e4e$exports = JSON.parse("{\"deselectedItem\":\"Nevybraté položky: {item}.\",\"select\":\"Vybrať\",\"selectedAll\":\"Všetky vybraté položky.\",\"selectedCount\":\"{count, plural, =0 {Žiadne vybraté položky} one {# vybratá položka} other {Počet vybratých položiek:#}}.\",\"selectedItem\":\"Vybraté položky: {item}.\"}");
...
$ea788b55810edc0f8005b062dd8ec58$exports = JSON.parse("{\"deselectedItem\":\"{item} seçilmedi.\",\"select\":\"Seç\",\"selectedAll\":\"Tüm ögeler seçildi.\",\"selectedCount\":\"{count, plural, =0 {Hiçbir öge seçilmedi} one {# öge seçildi} other {# öge seçildi}}.\",\"selectedItem\":\"{item} seçildi.\"}");
...
export function useGrid(props, state, ref) {
  ...
  let formatMessage = useMessageFormatter($e3c4cce891c32069b0b54eddd405e76$var$intlMessages);
  ...
  useUpdateEffect(() => {
    ...
    let addedKeys = $e3c4cce891c32069b0b54eddd405e76$var$diffSelection(selection, lastSelection.current);
    let removedKeys = $e3c4cce891c32069b0b54eddd405e76$var$diffSelection(lastSelection.current, selection); // If adding or removing a single row from the selection, announce the name of that item.
...
function $e3c4cce891c32069b0b54eddd405e76$var$diffSelection(a, b) {
  let res = new Set();
...
// @ts-ignore
const $dde6744d0523ac9ee9400214d8cfe169$var$intlMessages = {
  "ar-AE": _babelRuntimeHelpersEsmInteropRequireDefault($d754af426cd99d13f3c3b42e31b3$exports).default,
  "bg-BG": _babelRuntimeHelpersEsmInteropRequireDefault($b550e7ff21d43357d19c7d9f6403a388$exports).default,
  "cs-CZ": _babelRuntimeHelpersEsmInteropRequireDefault($e506453b0899c672fdbf2f4855f3721d$exports).default,
  "da-DK": _babelRuntimeHelpersEsmInteropRequireDefault($f209544680a65b4d4c1f36b455e32f8e$exports).default,
 ...
 */
export function useGridSelectionCheckbox(props, state) {
  let {
    key
  } = props;
  ...
  const formatMessage = useMessageFormatter($dde6744d0523ac9ee9400214d8cfe169$var$intlMessages);
  return {
    checkboxProps: {
      id: checkboxId,
